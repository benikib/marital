                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($nationalites as $nationalite)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $nationalite->personne->nom ?? 'N/A' }} {{ $nationalite->personne->postnom ?? ' -' }} {{ $nationalite->personne->prenom ?? '-' }} {{ $nationalite->personne->date_naissance->format('d/m/Y') ?? ' -' }}</td>
