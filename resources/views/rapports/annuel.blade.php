                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0">Rapport Annuel des Mariages</h6>
                            </div>
                            <div class="col-6 text-end">
                                <form action="{{ route('rapports.annuel') }}" method="GET"
                                    ...
                                    <a href="{{ route('rapports.annuel.print', ['annee' => $anneeActuelle]) }}"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="mb-0">Mariages par Mois</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table align-items-center mb-0">
                                                ...
                                                <tbody>
                                                    @foreach($statistiques['parMois'] as $mois => $total)
                                                        <tr>
                                                            <td>{{ Carbon\Carbon::create()->month($mois)->locale('fr')->isoFormat('MMMM') }}
                                                            </td>
                                                            <td>{{ $total }}</td>
                                                        </tr>
                                                    @endforeach
