...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div class="col-span-2">
        ...
        @if ($personne?->photo)
            <div class="mt-2">
                <img src="{{ asset('storage/photos/' . $personne->photo) }}"
    ...
    <div>
        ...
        <select name="province_id" class="mt-1 block w-full rounded-md border-gray-300">
            <option value="">Sélectionnez</option>
    ...
    <div>
        ...
        <select name="district_id" class="mt-1 block w-full rounded-md border-gray-300">
            <option value="">Sélectionnez</option>
    ...
    <div>
        ...
        <select name="territoire_id" class="mt-1 block w-full rounded-md border-gray-300">
            <option value="">Sélectionnez</option>
    ...
    <div>
        ...
        <select name="secteur_id" class="mt-1 block w-full rounded-md border-gray-300">
            <option value="">Sélectionnez</option>
    ...
    <div>
        ...
        <select name="localite_id" class="mt-1 block w-full rounded-md border-gray-300">
            <option value="">Sélectionnez</option>
            @foreach($entites as $localite)
                @if ($localite->type == 'Localité')
