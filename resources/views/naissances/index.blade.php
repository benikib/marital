                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($naissances as $naissance)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $naissance->personne->lieu_naissance ?? 'N/A' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $naissance->entite->nom  ?? 'N/A' }} ({{ ($naissance->entite->type  ?? 'N/A') }}) </td>
