...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Epouse>
 */
class EpouseFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'nationalite' => fake()->randomElement(['Congolaise', 'Congolaise (RDC)', 'Étrangère']),
